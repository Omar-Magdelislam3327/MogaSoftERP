...
namespace mogaERP.Infrastructure.Migrations
{
    ...
    [Migration("20250911100012_AddSupplierAndPriceQuatationTables")]
    partial class AddSupplierAndPriceQuatationTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("mogaERP.Domain.Entities.PriceQuotation", b =>
                {
                    ...
                    b.Property<int>("PurchaseRequestId2")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mogaERP.Domain.Entities.PriceQuotation", b =>
                {
                    ...
                    b.HasOne("mogaERP.Domain.Entities.PurchaseRequest", "PurchaseRequest")
                        .WithMany()
                        .HasForeignKey("PurchaseRequestId2")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("mogaERP.Domain.Entities.PurchaseRequest", b =>
                {
                    ...
                    b.HasOne("mogaERP.Domain.Entities.PriceQuotation", "PriceQuotation")
                        .WithOne()
                        .HasForeignKey("mogaERP.Domain.Entities.PurchaseRequest", "PriceQuotationId")
                        .OnDelete(DeleteBehavior.Restrict);
